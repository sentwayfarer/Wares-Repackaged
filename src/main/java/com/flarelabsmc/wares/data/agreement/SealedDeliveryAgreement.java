...
import com.flarelabsmc.wares.data.agreement.component.SealedRequestedItem;
import com.flarelabsmc.wares.data.agreement.component.SteppedInt;
import com.flarelabsmc.wares.data.agreement.component.TextProvider;
import com.flarelabsmc.wares.data.serialization.ComponentCodec;
...
public record SealedDeliveryAgreement(String id,
    ...
    public static final Codec<SealedDeliveryAgreement> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            ...
            Codec.either(ResourceLocation.CODEC, Codec.list(SealedRequestedItem.CODEC)).fieldOf("requested").forGetter(SealedDeliveryAgreement::requested),
            Codec.either(ResourceLocation.CODEC, Codec.list(ItemStack.CODEC)).fieldOf("payment").forGetter(SealedDeliveryAgreement::payment),
