...
public class DeliveryAgreement {
    public static final Codec<DeliveryAgreement> CODEC = RecordCodecBuilder.create(instance -> instance.group(
                    ...
                    Codec.list(RequestedItem.CODEC).fieldOf("requestedItems").forGetter(DeliveryAgreement::getRequested),
                    Codec.list(ItemStack.CODEC).fieldOf("paymentItems").forGetter(DeliveryAgreement::getPayment),
