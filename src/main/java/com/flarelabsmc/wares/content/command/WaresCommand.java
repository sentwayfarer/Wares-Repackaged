...
import com.flarelabsmc.wares.data.agreement.component.WeightedComponent;
import com.flarelabsmc.wares.test.Tests;
import com.flarelabsmc.wares.test.framework.TestingResult;
...
public class WaresCommand {
    ...
    private static int giveExampleSealedAgreement(CommandContext<CommandSourceStack> context) throws CommandSyntaxException {
        ...
        SealedDeliveryAgreement sealedAgreement = new SealedDeliveryAgreement("example_agreement_sealed",
                ...
                Either.left(ResourceLocation.withDefaultNamespace("chests/village/village_butcher")),
                Either.left(ResourceLocation.withDefaultNamespace("chests/buried_treasure")),
